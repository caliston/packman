...
cp RiscPkg/PackMan_0.7-3.zip /home/atm26/public_html/ephemeral/packman07.zip && \
pushd ../packages && \
./build-website &&\
 ./build-index &&\
popd
#rsync -av autobuilder_website/ tmarkettos@packages.riscosopen.org:/var/www/packages/
scp RiscPkg/PackMan_0.7-3.zip tmarkettos@packages.riscosopen.org:gccsdk412/autobuilder/autobuilder_packages/Admin/
